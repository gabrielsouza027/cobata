...
@st.cache_resource
def init_supabase():
    SUPABASE_URL = st.secrets.get("SUPABASE_URL", "https://mjxpathzhggdhgflaegu.supabase.co")
    SUPABASE_KEY = st.secrets.get("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1qeHBhdGh6aGdnZGhnZmxhZWd1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDY0NTkyMTYsImV4cCI6MjA2MjAzNTIxNn0.4-8e0V22iGaKC6Eh_mss242WNaR5LFG7IwpjR3JOPc0")
